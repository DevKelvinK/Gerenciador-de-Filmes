  ...
  <div class="max-w-[1366px] h-20 flex justify-between items-center px-6 mx-auto font-nunito">
    ...
    <nav>
      <ul class="flex items-center gap-6 text-gray-5">
        <li>
          <a href="/explore" class="flex items-center gap-2 px-3 py-2 rounded-md outline-none hover:bg-gray-2 focus:outline-purple-base transition-all duration-300 <?php if ($component == 'explore') echo 'componentActive'; ?>">
            <i class="ph ph-popcorn text-xl"></i>
            Explorar
          </a>
        </li>
        <li>
          <a href="myMovies" class="flex items-center gap-2 px-3 py-2 rounded-md outline-none hover:bg-gray-2 focus:outline-purple-base transition-all duration-300 <?php if ($component == 'myMovies') echo 'componentActive'; ?>">
